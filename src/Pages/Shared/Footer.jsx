          ...
          <div className='w-3/4 block sm:flex text-sm mt-6 lg:mt-0'>
            <ul className='text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full'>
              ...
              <li>
                <a
                  href='#'
                  className='inline-block py-2 pl-3 pr-5 text-white hover:text-white no-underline'
                >
                  Features
                </a>
              </li>
            ...
            <div className='text-gray-700 flex flex-col w-full'>
              ...
              <div className='flex pl-4 justify-start mt-2'>
                <a
                  className=' flex items-center text-white hover:text-white mr-6 no-underline'
                  href='#'
                >
                  <svg
                    viewBox='0 0 24 24'
                ...
                <a
                  className=' flex items-center text-white hover:text-white no-underline'
                  href='#'
                >
                  <svg
                    viewBox='0 0 24 24'
